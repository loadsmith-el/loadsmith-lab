...
This skill takes arguments `<service> <version> [data-ref] [notes]` (passed by the
invoking agent — e.g. Claude's `/create-source-image` slash command, or directly).
